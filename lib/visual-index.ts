...
export const visualIndex: VisualIndexGroup[] = [
  {
    ...
    terms: [
      ...
      { name: "冷蓝", english: "Cool Blue", definition: "由蓝、青及其灰阶组成的冷色环境。", effect: "拉开人物与环境的距离，并让湿度、夜色和孤独更容易被感知。", watchFor: "区分冷色是环境主色，还是只存在于阴影。", filterKey: "colors", filterValue: "冷蓝", frameIds: ["lane-neon", "train-window"] },
  ...
  },
  {
    ...
    terms: [
      ...
      { name: "框架", english: "Frame within Frame", definition: "利用门、窗、帘或镜面形成第二层画框。", effect: "把心理边界变成可见结构，也能延迟观众接近人物的时间。", watchFor: "比较人物是否共享同一个内部框架。", filterKey: "compositions", filterValue: "框架", frameIds: ["teahouse-window", "train-window"] },
  ...
  },
  {
    ...
    terms: [
      ...
      { name: "侧光", english: "Side Light", definition: "光线从主体一侧进入，另一侧保留阴影。", effect: "突出体积和材质，并让人物同时拥有显露与隐藏的两面。", watchFor: "比较亮侧和暗侧分别面向谁。", filterKey: "lights", filterValue: "侧光", frameIds: ["train-window", "hill-letter"] },
  ...
  },
  {
    ...
    terms: [
      ...
      { name: "近景", english: "Medium Close-up", definition: "通常容纳人物头肩或与之相当的观察距离。", effect: "兼顾表情与少量空间关系，适合表现犹疑和倾听。", watchFor: "观察背景是否仍在影响人物。", filterKey: "shotSize", filterValue: "近景", frameIds: ["train-window"] },
  ...
  },
  {
    ...
    terms: [
      ...
      { name: "神秘", english: "Mystery", definition: "关键因果被遮挡，但仍留下可追踪的视觉线索。", effect: "通过反射、逆光和半透明材质控制信息释放。", watchFor: "神秘感是否有明确问题，而非单纯看不清。", filterKey: "moods", filterValue: "神秘", frameIds: ["train-window", "teahouse-rain"] },
